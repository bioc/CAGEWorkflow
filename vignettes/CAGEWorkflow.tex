...
\StringTok{    }\KeywordTok{facet_zoom}\NormalTok{(}\DataTypeTok{x=}\NormalTok{IQR <=}\StringTok{ }\DecValTok{100}\NormalTok{) +}
...
\begin{center}\includegraphics{CAGEWorkflow_files/figure-latex/TSSShapes-1} \end{center}
...
\begin{center}\includegraphics{CAGEWorkflow_files/figure-latex/browseLinks-1} \end{center}
...
\begin{center}\includegraphics{CAGEWorkflow_files/figure-latex/browseStretches-1} \end{center}
...
\StringTok{    }\NormalTok{dplyr::}\KeywordTok{select}\NormalTok{(}\DataTypeTok{cluster=}\NormalTok{row, clusterType, txType, baseMean, log2FoldChange, padj) %>%}
\StringTok{    }\NormalTok{kable}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{table}\NormalTok{(}\DataTypeTok{Hnf4alpha=}\KeywordTok{motifMatches}\NormalTok{(motif_hits)[,}\StringTok{"MA0099.2"}\NormalTok{],}
      \DataTypeTok{DE=}\NormalTok{res$padj<}\FloatTok{0.05}\NormalTok{) %>%}
